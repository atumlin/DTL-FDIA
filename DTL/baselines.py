...
input_length = 102
source_data_path = ''  #please write your <source domain dataset> path here.
test_data_path = ''    #please write your <target domain dataset> path here.

source_data,test_data = scipy.io.loadmat(source_data_path),scipy.io.loadmat(test_data_path)
source_data,test_data = source_data['Dataset'],test_data['Dataset']
